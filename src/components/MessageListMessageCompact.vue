...
.kiwi-messagelist-message--compact .kiwi-messagelist-reactionbar {
    display: flex;
    flex-wrap: nowrap;
    gap: 4px;
    padding: 4px 0;
...
.kiwi-messagelist-message--compact .kiwi-messagelist-reactionbar-emoji {
    display: inline-flex;
    align-items: center;
...
.kiwi-messagelist-message--compact .kiwi-messagelist-reactionbar-emoji:hover:not(.kiwi-messagelist-reactionbar-emoji--disabled) {
    opacity: 1;
    background-color: rgba(128, 128, 128, 0.2);
    transform: scale(1.15);
}

.kiwi-messagelist-message--compact .kiwi-messagelist-reactionbar-emoji--selected {
    opacity: 1;
    background-color: rgba(66, 133, 244, 0.3);
}

.kiwi-messagelist-message--compact .kiwi-messagelist-reactionbar-emoji--disabled {
    cursor: not-allowed;
}

.kiwi-messagelist-message--compact .kiwi-messagelist-reactionbar-emoji--disabled:not(.kiwi-messagelist-reactionbar-emoji--selected) {
    filter: grayscale(0.8);
    opacity: 0.4;
}

.kiwi-messagelist-message--compact .kiwi-messagelist-reactionbar .kiwi-twemoji {
    height: 1.2em;
    width: 1.2em;
}
